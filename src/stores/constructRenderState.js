...
const createLayoutTemplateData = ({
  ...
  const resolvedRuntime = {
    ...
    autoForwardSpeed: runtime?.autoForwardSpeed ?? 50,
    ...
    localizationPackageId: runtime?.localizationPackageId ?? null,
  ...
  const templateData = {
    ...
    musicRoom,
    sceneReplay,
    localizationPackages: runtime?.localizationPackages ?? [],
    localizationPackageId: resolvedRuntime.localizationPackageId,
    runtime: resolvedRuntime,
    saveSlots,
    isChoiceVisible,
    isFormVisible,
...
export const addVoice = (
  ...
  const sounds = usesLegacySound
    ? voice.resourceId
      ...
      : []
    : voice.sounds;
  const loopsChannel = !usesLegacySound && voice.loop === true;
  const children = [];
