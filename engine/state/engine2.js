...
class RvnEngine {
  ...
  init() {
    ...
    this._persistentConfig = this.persistentConfigInterface.getAll() || this._initialPersistentConfig;
    this._persistentSaveData = this.persistentSaveInterface.getAll() || {};
    this._persistentVariables = this.persistentVariablesInterface.getAll() || {};
  ...
  handleEvent(event, payload) {
    ...
    this.handleAction(
      this._selectedPreset.events[event].action,
      payload || this._selectedPreset.events[event].payload
    );
  }
}
