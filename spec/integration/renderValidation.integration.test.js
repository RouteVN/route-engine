...
describe("engine render and package validation integration regressions", () => {
  it("uses the first spritesheet animation when a visual omits its name", () => {
  ...
  it("renders one visual when a resource ID is ambiguous", () => {
    const projectData = createIntegrationProject({
      resources: {
        images: {
  ...
  it("rejects non-finite L10n resource numbers during initialization", () => {
    const projectData = createIntegrationProject({
